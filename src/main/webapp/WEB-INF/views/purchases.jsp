...
<div class="container">
    ...
    <input type="search" id="searchById" class="form-control" style="margin-bottom:15px;"
           placeholder="Search by id" onkeyup="searchValue('#purchaseID', this.id)">
        ...
        <table class="table table-curved table-hover">
            ...
            <c:forEach items="${purchases}" var="purchase">
                <tr id="order${purchase.purchaseID}">
                    ...
                    <td> ${purchase.status}
                    <td><a class="btn btn-default" data-toggle="modal" href="#update${purchase.purchaseID}">Change status</a><br></td>
                </tr>


                <!-- out update form -->
                <div id="update${purchase.purchaseID}" class="modal fade"><div class="modal-dialog" style="padding-top: 165px;">
